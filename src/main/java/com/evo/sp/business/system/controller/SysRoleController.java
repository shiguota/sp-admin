...
public class SysRoleController extends BaseController {
    ...
    public Result delRole(@RequestBody List<String> ids) {
        return iSysRoleService.delRoles(ids);
    }

    /**
     * @api {post} /sys/role/modify 修改
     * @apiName modify
     * @apiGroup Role
     * @apiHeader {applications/json} ContentType 请求参数为json格式
    ...
    /**
     * @api {post} /sys/role/page 查询列表(分页)
     * @apiName login
     * @apiGroup Role
     * @apiHeader {applications/json} ContentType 请求参数为json格式
     ...
     * @apiParam (parameter) {String} orgId 机构id .
